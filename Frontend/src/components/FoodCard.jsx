...
const FoodCard = ({
  ...
  async function addToFavourite(e) {
    e.preventDefault();
    const result = await axios.post("https://seven-spices-1.onrender.com/api/favourites", {
      name,
      type,
      price,
      discount,
  ...
  async function deleteFavourite(e) {
    e.preventDefault();
    const result = await axios.post("https://seven-spices-1.onrender.com/api/delete-favourites", {
      name,
    } , {withCredentials: true});
  }
